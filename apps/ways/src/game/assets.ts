export default {
	...
	reelsFrame: {
		type: 'sprites',
		src: new URL('../../assets/sprites/reelsFrame/reel.json', import.meta.url).href
	},
	payFrame: {
		type: 'sprite',
	...
	foregroundAnimation: {
		type: 'spine',
		src: {
			atlas: new URL('../../assets/spines/foregroundAnimation/background.atlas', import.meta.url)
				.href,
			skeleton: new URL('../../assets/spines/foregroundAnimation/background.json', import.meta.url)
				.href,
			scale: 2
		},
		preload: true
